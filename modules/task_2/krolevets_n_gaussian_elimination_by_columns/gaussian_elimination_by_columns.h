// Copyright 2022 me
#ifndef MODULES_TASK_2_KROLEVETS_N_GAUSSIAN_ELIMINATION_BY_COLUMNS_GAUSSIAN_ELIMINATION_BY_COLUMNS_H_
#define MODULES_TASK_2_KROLEVETS_N_GAUSSIAN_ELIMINATION_BY_COLUMNS_GAUSSIAN_ELIMINATION_BY_COLUMNS_H_
...
class Gaussian_Solver {
 public:
  ...
  // input matrix MUST be stored by columns
  void set_matrix(const std::vector<float>& vec, uint32_t x, uint32_t y);
...
#endif  // MODULES_TASK_2_KROLEVETS_N_GAUSSIAN_ELIMINATION_BY_COLUMNS_GAUSSIAN_ELIMINATION_BY_COLUMNS_H_
